...
if submitted:
    try:
        ...
        with st.spinner("🤖 AI is analyzing patient metrics for health risk..."):
            ...
            prediction, prediction_conf, low_risk_score, mid_risk_score, high_risk_score = predict(df_testing)
            ...
            mid_risk_score_percentage = (mid_risk_score * 100).round(2)
            high_risk_score_percentage = (high_risk_score * 100).round(2)
            ...
            st.markdown(
                ...
                <div style='background-color: #1E1E1E; padding: 25px; border-radius: 12px; border-left: 6px solid #00C9FF; box-shadow: 0 4px 8px rgba(0,0,0,0.2); margin-top: 20px;'>
                    ...
                    <p style='color: #A0A0A0; margin-bottom: 5px; font-size: 14px; font-family: sans-serif;'>
                        📊 <strong>Probability Breakdown:</strong> Low: {low_risk_score_percentage}% | Mid: {mid_risk_score_percentage}% | High: {high_risk_score_percentage}%
                    </p>
        ...
        with st.spinner("🔍 AI is generating the reasoning behind this prediction..."):
            ...
            html_data = explain(df_testing_lime)
